...
final class LongBitSet implements Serializable {
    ...
    /**
     * Creates a new LongBitSet using the provided long[] array as backing store (it is used for clone method).
    ...
    /**
     * given a position, determine if the bit value in this position is equal to 1
     * @param index - the position of bit array
     * @return - true if bitArray[index] == 1
     */
    ...
    /**
     * given a position, set the bit value in this position to 1
    ...
    /**
     * given a position, determine if the bit value in this position is equal to 1.
     * then we set the position to 1
     * @param index - bit position
     * @return - bit value whether is 1
     */
    ...
    /**
     * Returns the index of the first set a bit starting at the index specified.
