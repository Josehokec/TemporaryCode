 ...
 * --------------------------------------------------------------------------------------------------------------------------
 * 中文解释：
 * 这个类是支持数值类型的等值谓词，比如 v1.beat = v2.beat, v1.beat = v2.beat + 1
 * 数值类型的等值谓词格式为：变量名.属性名 算术操作算子 数值常量 = 变量名.属性名 算术操作算子 数值常量
 * 注意：这里假设数值常量和属性名对应的数据类型相同
 * -> 关于check函数的isAlign的说明
 * 在这里检查一下是不是正序对齐的，如果V1变量名和谓词leftVariableName一样，V2变量名和谓词rightVariableName一样则称为对齐
 * 在这里检查一下是不是正序对齐的，如果V2变量名和谓词leftVariableName一样，V1变量名和谓词rightVariableName一样则称为倒序对齐
 */
public class EqualDependentPredicate extends DependentPredicate{
    ...
    public static void main(String[] args){
        ...
        edp4.print();
        System.out.println("true: " + edp3.check("v1", "XXX", "v2", "XXX", DataType.STRING));
        System.out.println("false: " + edp3.check("v1", "XXX", "v2", "YYY", DataType.STRING));
